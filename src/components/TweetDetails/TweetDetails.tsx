            ...
            <div>
              {tweetDetails ? ( 
                <Tweet
                  ...
                  userid={tweetDetails.User_Id}
                  name={tweetDetails.User.Name}
                  username={tweetDetails.User.Username}
                  text={tweetDetails.Content}
                  imageUrl={tweetDetails.Img_Url}
                  profileimageurl={tweetDetails.User.Profile?.[0]?.Img_Url}
                  timeDisplay={tweetDetails.timeDisplay}
                  likes={tweetDetails.likes}
                  retweets={tweetDetails.retweets}
                  comments={tweetDetails.comments}
                  saves={tweetDetails.saves}
                  bookmarked={tweetDetails.bookmarked}
                  author={tweetDetails.User.author}
                />
              ) : (
